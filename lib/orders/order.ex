defmodule Exlivery.Orders.Order do
  ...
  defp calculate_total_price(items), do: Enum.reduce(items, Decimal.new("0.00"), &sum_prices/2)

  defp sum_prices(%Item{unity_price: price, quantity: quantity}, subtotal) do
    price
    |> Decimal.mult(quantity)
    |> Decimal.add(subtotal)
  end
end
